...
<!--			</view>-->
			<view class="form-item">
				<label>支付宝姓名</label>
				<input v-model="userInfo.banknum" maxlength="19" type="number" placeholder="请输入支付宝收款姓名"
					autocomplete="off" class="input" />
			</view>
      <view class="form-item">
        <label>微信姓名</label>
        <input v-model="userInfo.banknum" maxlength="19" type="number" placeholder="请输入微信收款姓名"
               autocomplete="off" class="input" />
      </view>
...
<script>
	import {userAuth} from "../../api/members";
